...
class RunMapModel extends think\Model
{
    public function add($data)
    {
        ...
        $data_i["create_time"] = time();
        $data_i["last_execute_time"] = $data_i["create_time"];
    ...
    public function getAllPage($data, $page, $limit, $orderby, $sorting, $supplier_id = 0)
    {
        ...
        $where = function (\think\db\Query $query) use ($keywords, $from_type, $status, $user, $active_type) {
            static $supplier_id = NULL;
            if (!empty($keywords)) {
