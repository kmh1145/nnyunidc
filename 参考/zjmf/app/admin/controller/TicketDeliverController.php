...
class TicketDeliverController extends AdminBaseController
{
    ...
    {
        $params = input("post.");
        if (0 < count($params["departments"]) && is_array($params["departments"])) {
            ...
            if (0 < count($params["products"]) && is_array($params["products"])) {
    ...
    public function save()
    {
        ...
        if (0 < count($params["departments"]) && is_array($params["departments"])) {
            ...
            if (0 < count($params["products"]) && is_array($params["products"])) {
                ...
                $data["mask_keywords"] = !empty($params["mask_keywords"]) ? $params["mask_keywords"] : "";
                if (isset($params["mask_keywords"]) && $data["mask_keywords"] != $info["mask_keywords"] && $data["mask_keywords"] != $info["mask_keywords"]) {
