...
class Pricing
{
    ...
    {
        $data = ["osetupfee" => round(floatval($value["osetupfee"]), 2), "hsetupfee" => round(floatval($value["hsetupfee"]), 2), "dsetupfee" => round(floatval($value["dsetupfee"]), 2), "ontrialfee" => round(floatval($value["ontrialfee"]), 2), "msetupfee" => round(floatval($value["msetupfee"]), 2), "qsetupfee" => round(floatval($value["qsetupfee"]), 2), "ssetupfee" => round(floatval($value["ssetupfee"]), 2), "asetupfee" => round(floatval($value["asetupfee"]), 2), "bsetupfee" => round(floatval($value["bsetupfee"]), 2), "tsetupfee" => round(floatval($value["tsetupfee"]), 2), "foursetupfee" => round(floatval($value["foursetupfee"]), 2), "fivesetupfee" => round(floatval($value["fivesetupfee"]), 2), "sixsetupfee" => round(floatval($value["sixsetupfee"]), 2), "sevensetupfee" => round(floatval($value["sevensetupfee"]), 2), "eightsetupfee" => round(floatval($value["eightsetupfee"]), 2), "ninesetupfee" => round(floatval($value["ninesetupfee"]), 2), "tensetupfee" => round(floatval($value["tensetupfee"]), 2), "onetime" => 0 <= round(floatval($value["onetime"]), 2) ? round(floatval($value["onetime"]), 2) : 0, "hour" => 0 <= round(floatval($value["hour"]), 2) ? round(floatval($value["hour"]), 2) : 0, "day" => 0 <= round(floatval($value["day"]), 2) ? round(floatval($value["day"]), 2) : 0, "ontrial" => 0 <= round(floatval($value["ontrial"]), 2) ? round(floatval($value["ontrial"]), 2) : 0, "monthly" => 0 <= round(floatval($value["monthly"]), 2) ? round(floatval($value["monthly"]), 2) : 0, "quarterly" => 0 <= round(floatval($value["quarterly"]), 2) ? round(floatval($value["quarterly"]), 2) : 0, "semiannually" => 0 <= round(floatval($value["semiannually"]), 2) ? round(floatval($value["semiannually"]), 2) : 0, "annually" => 0 <= round(floatval($value["annually"]), 2) ? round(floatval($value["annually"]), 2) : 0, "biennially" => 0 <= round(floatval($value["biennially"]), 2) ? round(floatval($value["biennially"]), 2) : 0, "triennially" => 0 <= round(floatval($value["triennially"]), 2) ? round(floatval($value["triennially"]), 2) : 0, "fourly" => 0 <= round(floatval($value["fourly"]), 2) ? round(floatval($value["fourly"]), 2) : 0, "fively" => 0 <= round(floatval($value["fively"]), 2) ? round(floatval($value["fively"]), 2) : 0, "sixly" => 0 <= round(floatval($value["sixly"]), 2) ? round(floatval($value["sixly"]), 2) : 0, "sevenly" => 0 <= round(floatval($value["sevenly"]), 2) ? round(floatval($value["sevenly"]), 2) : 0, "eightly" => 0 <= round(floatval($value["eightly"]), 2) ? round(floatval($value["eightly"]), 2) : 0, "ninely" => 0 <= round(floatval($value["ninely"]), 2) ? round(floatval($value["ninely"]), 2) : 0, "tenly" => 0 <= round(floatval($value["tenly"]), 2) ? round(floatval($value["tenly"]), 2) : 0];
        return $data;
    }
